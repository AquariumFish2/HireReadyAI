    ...
    <div className="bg-background border border-border/60 rounded-xl shadow-xs p-5 lg:p-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
        ...
        <button
          ...
          className="self-start sm:self-center flex items-center gap-1.5 bg-secondary hover:bg-secondary/80 text-foreground border border-border px-3 py-1.5 rounded-lg text-xs font-medium transition-colors cursor-pointer select-none"
        >
