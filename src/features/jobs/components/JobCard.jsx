        ...
        <div className="flex items-start gap-4 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-1.5 mt-1 flex-wrap">
              {company?.name && (
                <span className="text-sm text-dark-amethyst-500 font-medium">
                  {company.name}
                </span>
              )}
              {company?.location && (
                <>
                  ...
                  <span className="text-sm text-dark-amethyst-400">
                    {company.location}
                  </span>
                </>
              )}
            ...
            {job.responsibilities?.length > 0 && (
              <ul className="mt-4 space-y-1">
                {job.responsibilities.slice(0, 2).map((item, i) => (
                  <li
                    key={i}
                    className="flex items-start gap-2 text-dark-amethyst-700 text-sm"
                  >
