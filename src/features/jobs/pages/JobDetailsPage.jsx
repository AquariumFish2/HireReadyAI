...
export default function JobDetailsPage() {
  ...
  if (error) return <p className="p-8 text-red-500 text-sm font-medium">Error: {error}</p>;
  if (!job) return <p className="p-8 text-slate-500 text-sm font-medium">Job not found</p>;
