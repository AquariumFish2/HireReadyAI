...
export default function Customers() {
  ...
  const testimonials = [
    {
      id: 1,
      content:
        "HireReadyAI transformed our hiring process completely. The AI-driven resume screening saved us countless hours and brought the best talent directly to our pipeline.",
      name: "Sarah Jenkins",
    ...
    },
    {
      id: 2,
      content:
        "The collaborative team voting and clear candidate pipeline made decision-making effortless. It perfectly aligns our hiring team to choose the best talent.",
      name: "Layla Ibrahim",
    ...
    },
    {
      id: 3,
      content:
        "The candidate pipeline management is incredibly intuitive. We can easily track scores, advance candidates, and make confident hiring decisions fast.",
  ...
  return (
    <section
      id="customers"
      className="bg-surface-muted px-6 py-20 border-y border-border/40"
    >
      <style>{`
      ...
      <div className="max-w-6xl mx-auto space-y-12 relative z-10">
        <div className="text-center space-y-3 max-w-2xl mx-auto">
          <span className="inline-block text-[10px] font-extrabold tracking-[0.2em] text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/10 uppercase">
            {t("landing.customers.testimonials")}
          </span>
          <h2 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl">
            {t("landing.customers.loved_by")}
          </h2>
        </div>
