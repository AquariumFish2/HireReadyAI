...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (newPassword.length < 8) {
      setValidationError(t("reset_password.form.errors.min_length"));
      return;
    }

    if (newPassword !== confirmPassword) {
      setValidationError(t("reset_password.form.errors.not_match"));
      return;
    }
    ...
    try {
      ...
      setApiError(err.message || t("reset_password.form.errors.generic"));
    }
  };
