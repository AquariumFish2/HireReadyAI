    ...
    <div className="flex flex-col h-full bg-secondary/30 overflow-hidden">
      ...
      <div className="bg-background border-b border-border px-6 py-4 shrink-0">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-bold text-foreground font-display">Shortlist</h1>
            <p className="text-xs text-muted-foreground mt-0.5">Top candidates surfaced by AI · awaiting hiring team decision</p>
          </div>
