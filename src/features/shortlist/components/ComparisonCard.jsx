...
export default function ComparisonCard({ application, provided, isDragging }) {
  ...
  return (
    <div
      ...
      className={`bg-white rounded-xl shadow-sm border p-6 min-w-[280px] w-[320px] shrink-0 font-sans transition-shadow ${isDragging ? "border-dark-amethyst-500 shadow-lg ring-1 ring-dark-amethyst-500" : "border-gray-100 hover:shadow-md"
        }`}
    >
